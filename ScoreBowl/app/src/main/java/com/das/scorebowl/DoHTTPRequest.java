...
public class DoHTTPRequest extends AsyncTask<String, Void, String> {
    ...
    public DoHTTPRequest(Context context, String reqId, int progressBarId, String [] datos) {
        ...
        switch(mReqId){
            //TODO: cada nuevo PHP actualizar
            case "add":
                try {
            ...
            case "updateEmail":
                try {
                    param = "Nombre=" + URLEncoder.encode(datos[0], "UTF-8");
                    param += "&Email=" + URLEncoder.encode(datos[1], "UTF-8");
                } catch (UnsupportedEncodingException e) {
                    e.printStackTrace();
                }
                break;
    ...
    protected String doInBackground(String... params) {
        ...
        String st = "http://galan.ehu.eus/ugarcia029/WEB/bolos/";
        switch(mReqId) {
            //TODO: cada nuevo php actualizar
            case "add": st += "add.php"; break;
            case "validar": st += "validarUser.php"; break;
            case "existe": st += "existeUser.php"; break;
            case "getEmail": st += "getEmail.php"; break;
            case "updateEmail": st += "updateEmail.php"; break;
            case "updatePass": st += "updatePass.php"; break;
            default: break;
        }
